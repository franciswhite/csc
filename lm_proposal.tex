...
\includegraphics[width=0.9\linewidth]{act.png} 
\caption{ACT-R Structure}
\label{fig:subim1}
\end{wrapfigure}
...
\end{enumerate}
The BDI model obtained from the conceptual study of expert knowledge will serve as the basis for the implementation of the knowledge structure involved in the task. EXPAND ME!!!!\\
