...
Stanovich: rules \& individual differences, factors like age, cognitive capacities and so on. \\
paradigm: exclude people with logical training from the sample
Why do we need a model of expert knowledge? what questions can be answered? We want to know \textbf{in what way} the performance is enhanced. 
...
ACT-r ; gives us means to implement what we know from the conceptual model about the descriptive and the procedural aspects of logical knowledge
...
Is experts' performance on logical reasoning task to be explained by \emph{procedural} knowledge - presumably consisting of an interaction of general intelligence and prior experience with similar problems - or by \emph{factual} knowledge - knowing rules of formal logic?
